...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        [0] = LAYOUT_split_3x5_3(KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, LGUI_T(KC_A), LSFT_T(KC_S), LCTL_T(KC_D), LALT_T(KC_F), KC_G, KC_H, LALT_T(KC_J), LCTL_T(KC_K), LSFT_T(KC_L), LGUI_T(KC_QUOT), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, LT(5,KC_ESC), LT(1,KC_SPC), LT(2,KC_BSPC), LT(3,KC_TAB), LT(4,KC_ENT), KC_DEL),
        [1] = LAYOUT_split_3x5_3(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, C(KC_C), C(KC_V), KC_NO, KC_NO, KC_LGUI, KC_LSFT, KC_LCTL, KC_LALT, KC_NO, CW_TOGG, KC_PGUP, KC_PGDN, KC_HOME, KC_END, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, TD(DANCE_0), KC_LEFT, KC_RGHT, KC_UP, KC_DOWN, KC_TRNS, KC_TRNS, KC_NO, KC_TAB, KC_ENT, KC_DEL),
        [2] = LAYOUT_split_3x5_3(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MINS, KC_LBRC, KC_RBRC, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_SCLN, KC_BSLS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_GRV, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_TRNS, KC_TAB, KC_ENT, KC_NO),
        [3] = LAYOUT_split_3x5_3(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_7, KC_8, KC_9, KC_MINS, KC_EQL, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_4, KC_5, KC_6, KC_NO, KC_INS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_1, KC_2, KC_3, KC_DOT, KC_GRV, KC_NO, KC_SPC, KC_BSPC, KC_TRNS, KC_NO, KC_0),
        [4] = LAYOUT_split_3x5_3(KC_NO, KC_NO, KC_NO, RGB_TOG, QK_BOOT, KC_F7, KC_F8, KC_F9, RGB_TOG, KC_F12, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_F4, KC_F5, KC_F6, KC_NO, KC_F11, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_F1, KC_F2, KC_F3, KC_NO, KC_NO, KC_TRNS, KC_SPC, KC_BSPC, KC_NO, KC_TRNS, KC_F10),
        [5] = LAYOUT_split_3x5_3(KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_WH_U, KC_MS_U, KC_WH_D, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_NO, KC_MS_L, KC_MS_D, KC_MS_R, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_NO, KC_NO, KC_BTN1, KC_BTN2, KC_NO)
};
...
bool rgb_matrix_indicators_user(void) {
    switch (get_highest_layer(layer_state)) {
        case 5:
            ...
            // mod keys LHS/
            rgb_matrix_set_color(11, rgb_purple.r, rgb_purple.g, rgb_purple.b);
            rgb_matrix_set_color(16, rgb_purple.r, rgb_purple.g, rgb_purple.b);
        ...
        case 4:
            ...
            rgb_matrix_set_color(11, rgb_red.r, rgb_red.g, rgb_red.b);
            rgb_matrix_set_color(16, rgb_red.r, rgb_red.g, rgb_red.b);
        ...
        case 3:
            ...
            // mod keys LHS/
            rgb_matrix_set_color(11, rgb_turquoise.r, rgb_turquoise.g, rgb_turquoise.b);
            rgb_matrix_set_color(16, rgb_turquoise.r, rgb_turquoise.g, rgb_turquoise.b);
        ...
        case 2:
            ...
            // mod keys LHS/
            rgb_matrix_set_color(11, rgb_yellow.r, rgb_yellow.g, rgb_yellow.b);
            rgb_matrix_set_color(16, rgb_yellow.r, rgb_yellow.g, rgb_yellow.b);
        ...
        case 1:
            ...
            rgb_matrix_set_color_all(0, 0, 0);
            rgb_matrix_set_color(11, rgb_springgreen.r, rgb_springgreen.g*5, rgb_springgreen.b);
            rgb_matrix_set_color(16, rgb_springgreen.r, rgb_springgreen.g*5, rgb_springgreen.b);
        ...
        case 0:
            ...
            // mod keys LHS/
            rgb_matrix_set_color(11, rgb_blue.r, 0, rgb_blue.b);
            rgb_matrix_set_color(16, rgb_blue.r, 0, rgb_blue.b);
